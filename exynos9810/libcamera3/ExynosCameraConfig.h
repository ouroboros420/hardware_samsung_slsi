...
#define USE_DUAL_PREVIEW_HW             (true)
#define USE_DUAL_PREVIEW_SW             (false)
#define USE_DUAL_REPROCESSING_HW        (true)
#define USE_DUAL_REPROCESSING_SW        (false)
...
#define USE_FASTEN_AE_STABLE_FRONT      (true)

#define FASTEN_AE_FPS                   (120)
#define FASTEN_AE_FPS_FRONT             (120)
...
#define TORCH_REAR_FILE_PATH "/sys/class/camera/flash/rear_flash"
#define TORCH_FRONT_FILE_PATH "/sys/class/camera/flash/rear_flash"
...
#ifdef USE_DUAL_CAMERA
#define MAIN_CAMERA_DUAL_ISP_MCSC_OTF       (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_DUAL_ISP_MCSC_OTF      (HW_CONNECTION_MODE_NONE)
...
#define SUB_CAMERA_DUAL_MCSC_VRA_OTF        (HW_CONNECTION_MODE_OTF)
#endif
...
#ifdef USE_DUAL_CAMERA
#define MAIN_CAMERA_DUAL_ISP_MCSC_OTF_REPROCESSING      (HW_CONNECTION_MODE_NONE)
#define FRONT_CAMERA_DUAL_ISP_MCSC_OTF_REPROCESSING     (HW_CONNECTION_MODE_NONE)
