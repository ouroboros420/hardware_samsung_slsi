...
//	sensorType, sensorInterface, busId, addr, regAddr,  speed, priority
    {TYPE_SENSOR_ACC_GYRO/*SENS_TYPE_ACCEL*/,   0x0/*SPI*/, ACC_GYR_SPI_BUS_ID, ACC_I2C_ADDR/*none for SPI*/, ACC_REG_ID/*BMI160_REG_ID*/, ACC_SPI_SPEED/*none for SPI*/, (PRI<<SHIFT_TYPE_ACCEL)},
...
#ifdef USE_BARO
    {TYPE_SENSOR_BARO/*SENS_TYPE_BARO*/,        0x1/*I2C*/, BARO_I2C_BUS_ID,    BARO_I2C_ADDR/*BMP280_I2C_ADDR*/, BARO_REG_ID/*BOSCH_BMP280_REG_ID*/, BARO_I2C_SPEED/*BMP280_I2C_SPEED*/, (PRI<<SHIFT_TYPE_BARO)},
#endif
};
...
static uint8_t sensorCombination[][NUM_MOUNTED_PHYSICAL_SENSOR+1][2] = {
    ...
    {
        {TYPE_SENSOR_ACC_GYRO/*SENS_TYPE_ACCEL*/, ACC_CHIP_ID/*BMI160_ID*/},
        {TYPE_SENSOR_MAG/*SENS_TYPE_MAG*/, MAG_CHIP_ID /*AK09918_WIA*/},
        {TYPE_SENSOR_ALS_PROX/*SENS_TYPE_ALS*/, PROX_CHIP_ID/*ROHM_RPR0521_ID*/},
#ifdef USE_BARO
        {TYPE_SENSOR_BARO/* SENS_TYPE_BARO*/, BARO_CHIP_ID/*BOSCH_BMP280_ID*/},
