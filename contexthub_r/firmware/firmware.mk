...
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/cmgp
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/cmu
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/cpu
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/csp
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/gpio
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/i2c
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/mailbox
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/pwm
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/pwr
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/rtc
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/spi
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/sysreg
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/usi
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/wdt
ifeq ($(ADC_REQUIRED), YES)
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/adc
endif
ifeq ($(PDMA_REQUIRED), YES)
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/pdma
endif
ifeq ($(TIMER_REQUIRED), YES)
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/timer
endif
ifeq ($(UART_REQUIRED), YES)
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/uart
endif
ifeq ($(EXYNOS_VSYNC), YES)
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/csis
endif
ifeq ($(SLIF_REQUIRED), YES)
FLAGS += -Ios/platform/$(PLATFORM)/inc/plat/slif
endif
endif
