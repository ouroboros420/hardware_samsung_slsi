...
// I2C GPIO pad configuration is dealt with in gpioBoardInit
#if 0
struct ExynosI2cGpioCfg {
    uint8_t gpioNum;
    enum exynosGpioFunc func;
};
#endif
...
// I2C GPIO pad configuration is dealt with in gpioBoardInit
#if 0
    struct ExynosI2cGpioCfg gpioScl;
    struct ExynosI2cGpioCfg gpioSda;
    enum exynosGpioSpeed gpioSpeed;
...
// I2C GPIO pad configuration is dealt with in gpioBoardInit
#if 0
#define XUSI1_SDA0_MISO_RXD   { .gpioNum = GPIO_PD1(4), .func = GPIO_FUNC_USI_ALT }
#define XUSI1_SCL0_MOSI_TXD   { .gpioNum = GPIO_PD1(5), .func = GPIO_FUNC_USI_ALT }
#endif
