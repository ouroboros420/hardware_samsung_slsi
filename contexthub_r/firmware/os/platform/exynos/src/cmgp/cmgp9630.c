...
#ifndef __CMGP9630_C__
#define __CMGP9630_C__
...
struct CmgpIrqInfoType mCmgpIrqInfo[64] = {
    ...
    DEC_CMGP_IRQ( CMGP_I2C1_IRQ, I2C_CMGP3, CMGP_IRQ_GROUP_I2C ),
    DEC_CMGP_IRQ( CMGP_USI2_IRQ, USI_CMGP2, CMGP_IRQ_GROUP_USI ),
    DEC_CMGP_IRQ( CMGP_I2C2_IRQ, I2C_CMGP5, CMGP_IRQ_GROUP_I2C ),
    DEC_CMGP_IRQ( CMGP_USI3_IRQ, USI_CMGP3, CMGP_IRQ_GROUP_USI ),
    DEC_CMGP_IRQ( CMGP_I2C3_IRQ, I2C_CMGP7, CMGP_IRQ_GROUP_I2C ),

    DEC_CMGP_IRQ( CMGP_ADC_IRQ, CMGP_ADC_IRQ, CMGP_IRQ_GROUP_ADC ),
