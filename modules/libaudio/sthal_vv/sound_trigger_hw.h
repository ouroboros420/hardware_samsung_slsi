...
#define BARGEIN_STARTCOPY_CTL_NAME     "ABOX ODM BI StartCopy"
#define BARGEIN_KWDTYPE_CTL_NAME       "ABOX ODM BI KWD Type"
#define BARGEIN_KWDLENGTH_CTL_NAME     "ABOX ODM BI KWD Length"
#define VTS_KWDLENGTH_CTL_NAME         "VTS Keyword Length"

#define KW_LENGTH                   (16 * 2 * 2 * 2200)
...
int odmvoice_triggerrecognize_stop_ctlvalue[] = {
    0, //"VTS Active Keyphrase",
    VTS_MODE_ODMVOICE_TRIGGER_OFF, //"VTS Execution Mode",
};
...
struct sound_trigger_device {
    ...
    int is_model_recognize_configured;
    void *audio_primary_lib;
#ifdef SUPPORT_BARGEIN_MODE
    struct pcm *bargein_trigger;
    int (*notify_set_bargein_route)(bool);
    SOUND_CARD_STATE sound_card_state;
#endif
    int (*notify_set_vts_route)(bool, int);
    int is_recording;
