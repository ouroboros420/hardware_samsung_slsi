...
LOCAL_C_INCLUDES += \
	...
	$(DEVICE_BASE_PATH)/$(TARGET_DEVICE_NAME)/$(CONF_NAME) \
	$(DEVICE_BASE_PATH)/$(PRODUCT_DEVICE)/conf
...
ifeq ($(BOARD_USE_BARGEIN_MODE), true)
LOCAL_CFLAGS += -DSUPPORT_BARGEIN_MODE
ifeq ($(BOARD_USE_AUDIO_MONITOR),true)
LOCAL_CFLAGS += -DSUPPORT_AUDIO_MONITOR
endif
endif
