...
#define DEBUG_DUMP_MAX 10
#define DEBUG_DUMP_CONDITION(pipeId) ((pipeId == PIPE_MCSC0 || pipeId == PIPE_VC0))
#endif
...
#define DUAL_CAMERA_TRANSITION_BY_LIBRARY
#ifdef DUAL_CAMERA_TRANSITION_BY_LIBRARY
/* view ratio range(1.0 ~ 8.0 * scaling by 1000) : flash scenario, etc
*
* W : Wide
* T : Tele
*
* view_ratio   Preview  Capture  Capture(flash)
*  1000~1499     W         W         W
*  1500~2000    W+T       W+T        W
*  2001~3099    W+T       W+T        T
*  3100~8000     T         T         T
*/
#define DUAL_CAPTURE_BYPASS_MODE_MIN_VIEW_RATIO (1000.0F)
#define DUAL_CAPTURE_BYPASS_MODE_MAX_VIEW_RATIO (2000.0F)
#define DUAL_CAPTURE_SWITCH_MODE_MIN_VIEW_RATIO (2000.0F)
#define DUAL_CAPTURE_SWITCH_MODE_MAX_VIEW_RATIO (8000.0F)
#endif
...
/* For PlugIn Features */
#ifdef USES_LLS_SOLUTION
#define SUPPORT_ME
/* #define USE_LLS_PREVIEW */
#define USE_LLS_REPROCESSING
/* #define TEST_LLS_REPROCESING */
#endif
...
(BOUNDDRY_IN_ZOOM_FRONT)-------------------------------------BV
                             (BOUNDARY_IN_VALUE) (BOUNDARY_OUT_VALUE)
*/
...
#define MAIN_CAMERA_DUAL_ISP_DCP_OTF        (HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_DUAL_ISP_DCP_OTF       (HW_CONNECTION_MODE_VIRTUAL_OTF)
...
#define MAIN_CAMERA_DUAL_DCP_MCSC_OTF      	(HW_CONNECTION_MODE_M2M)
#define FRONT_CAMERA_DUAL_DCP_MCSC_OTF      (HW_CONNECTION_MODE_OTF)
...
#ifdef USE_PAF
/* 3PAF - 3AA */
#define MAIN_CAMERA_SINGLE_3PAF_3AA_OTF_REPROCESSING     (HW_CONNECTION_MODE_OTF)
#define FRONT_CAMERA_SINGLE_3PAF_3AA_OTF_REPROCESSING    (HW_CONNECTION_MODE_OTF)
#define MAIN_CAMERA_PIP_3PAF_3AA_OTF_REPROCESSING        (HW_CONNECTION_MODE_NONE) /* need to be same with FRONT_CAMERA_DUAL_3PAF_3AA_OTF on dual case */
#define FRONT_CAMERA_PIP_3PAF_3AA_OTF_REPROCESSING       (HW_CONNECTION_MODE_NONE)
#ifdef USE_DUAL_CAMERA
#define MAIN_CAMERA_DUAL_3PAF_3AA_OTF_REPROCESSING       (HW_CONNECTION_MODE_NONE) /* need to be same with FRONT_CAMERA_DUAL_3PAF_3AA_OTF on dual case */
#define FRONT_CAMERA_DUAL_3PAF_3AA_OTF_REPROCESSING      (HW_CONNECTION_MODE_NONE)
#define SUB_CAMERA_DUAL_3PAF_3AA_OTF_REPROCESSING        (HW_CONNECTION_MODE_NONE)
#endif
#endif /* USE_PAF */
...
#define SUB_CAMERA_DUAL_MCSC_VRA_OTF_REPROCESSING       (HW_CONNECTION_MODE_OTF)
#endif
#else /* USE_EARLY_FD */
/* MCSC - VRA */
...
#define NUM_DCP_BUFFERS                     (NUM_HW_DIS_BUFFERS) / 4
...
enum pipeline {
    ...
    PIPE_CIPS1,
    PIPE_DIS,
    PIPE_TPU = PIPE_DIS, // 23
    PIPE_TPUP,
    PIPE_MCSC,
    PIPE_SCP,
    PIPE_MCSC0 = PIPE_SCP, // 26
    PIPE_MCSC1,
    PIPE_MCSC2,
    PIPE_MCSC3,
    PIPE_MCSC4,
    ...
    PIPE_PLUGIN_BASE,
    PIPE_PLUGIN_PRE1 = PIPE_PLUGIN_BASE,
    PIPE_PLUGIN_PRE2,
    PIPE_PLUGIN_POST1,
    PIPE_PLUGIN_POST2,
    PIPE_PLUGIN_MAX = PIPE_PLUGIN_POST2,
#endif
    MAX_PIPE_NUM,
...
#ifdef USE_PAF
    FIMC_IS_VIDEO_P0S_NUM = 240,
    FIMC_IS_VIDEO_P1S_NUM = 241,
#endif
