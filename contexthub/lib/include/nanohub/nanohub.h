...
#define NANOHUB_VENDOR_EXYNOS      UINT64_C(0x4578796E6F) // "Exyno"
#define NANOHUB_VENDOR_TI          UINT64_C(0x5449202020) // "TI   "
...
#define FLASH_RELOC_OFFSET (0)       // used by appSupport.c at run time
#else
