...
void sysregDrvSetPdReq(IN bool en);
uint32_t sysregDrvGetPdReq(void);
void sysregDrvSetEarlyWakeupWindowReq(IN bool en);
uint32_t sysregDrvGetEarlyWakeupWindowReq(void);
void sysregDrvSetVvalidIntr(IN bool negEdge, IN bool intMask);
void sysregDrvSetMIFReq(IN bool enable);
uint32_t sysregDrvGetMIFAck(void);
void sysregDrvClrMIFReqAck(void);
void sysregDrvSetAPMReq(IN bool enable);
uint32_t sysregDrvGetAPMAck(void);
void sysregDrvClrAPMReqAck(void);
uint32_t sysregDrvGetAPMUpStatus(void);
void sysregDrvSaveState(void);
void sysregDrvRestoreState(void);
void sysregDrvCmgpSaveState(void);
void sysregDrvCmgpRestoreState(void);
#endif
