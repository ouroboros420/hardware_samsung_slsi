...
#ifndef __GPIO8825_H__
#define __GPIO8825_H__
...
#define     I2C_CHUB1_SDA                  0x3
    GPH01_0,
#define     USI_CHUB2_RXD_SPICLK_SCL       0x2
    GPH01_1,
#define     USI_CHUB2_TXD_SPIDO_SDA        0x2
    GPH01_2,
#define     USI_CHUB2_RTS_SPIDI            0x2
    GPH01_3,
#define     USI_CHUB1_CTS_SPICS            0x2
...
#define     USI_CHUB3_RXD_SPICLK_SCL       0x5
    GPM01_0,
#define     USI_CMGP0_TXD_SPIDO_SDA        0x2
#define     USI_CHUB3_TXD_SPIDO_SDA        0x5
    GPM02_0,
#define     USI_CMGP0_RTS_SPIDI            0x2
#define     I2C_CMGP0_SCL                  0x3
#define     I3C_CMGP_SCL                   0x4
#define     USI_CHUB3_RTS_SPIDI            0x5
#define     I2C_CHUB3_SCL                  0x6
    GPM03_0,
#define     USI_CMGP0_CTS_SPICS            0x2
#define     I2C_CMGP0_SDA                  0x3
#define     I3C_CMGP_SDA                   0x4
#define     USI_CHUB3_CTS_SPICS            0x5
#define     I2C_CHUB3_SDA                  0x6
    GPM04_0,
