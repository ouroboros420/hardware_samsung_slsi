...
#ifndef __CMU8825_H__
#define __CMU8825_H__
...
typedef enum {
    ...
    CMU_MUX_CLK_CHUB_PERI_USER,
    CMU_MUX_CLK_CHUB_RCO_USER,
    CMU_MUX_CLK_CHUB_BUS_USER,
    CMU_MUX_CLK_CHUB_BUS,
    CMU_MUX_CLK_CHUB_I2C,
    CMU_MUX_CLK_CHUB_TIMER,
    CMU_MUX_CLK_CHUB_USI0,
    CMU_MUX_CLK_CHUB_USI1,
    CMU_MUX_CLK_CHUB_USI2,
    CMU_MUX_CLK_CHUB_USI3,
