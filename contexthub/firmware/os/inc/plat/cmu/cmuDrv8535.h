...
#ifndef __CMU_DRIVER_8535_H__
#define __CMU_DRIVER_8535_H__
...
#define REG_CMU_PLL_CON0_MUX_CLKCMU_CHUB_NOC_USER           (CMU_BASE_ADDRESS + 0x610)
#define REG_CMU_PLL_CON1_MUX_CLKCMU_CHUB_NOC_USER           (CMU_BASE_ADDRESS + 0x614)
...
#define REG_CMU_CLK_CON_MUX_CLK_CHUB_I2C1                   (CMU_BASE_ADDRESS + 0x1008)
#define REG_CMU_CLK_CON_MUX_CLK_CHUB_I2C2                   (CMU_BASE_ADDRESS + 0x1018)

#define REG_CMU_CLK_CON_MUX_CLK_CHUB_I3C                    (CMU_BASE_ADDRESS + 0x101C)
...
#define REG_CMU_CLK_CON_DIV_CLK_CHUB_I2C1                   (CMU_BASE_ADDRESS + 0x1800)
...
#define REG_CMU_CLK_CON_DIV_CLK_CHUB_I2C2                   (CMU_BASE_ADDRESS + 0x1814)
#define REG_CMU_CLK_CON_DIV_CLK_CHUB_I3C                    (CMU_BASE_ADDRESS + 0x1818)
#define REG_CMU_CLK_CON_DIV_CLK_CHUB_ECU                    (CMU_BASE_ADDRESS + 0x181C)
...
// --Selection for Mux p-4037 need to check(To do) 
