...
#define EVT_DEBUG_DUMP                   0x00007F02    //send message payload to Linux kernel log
#define EVT_DFS_TO_SENSOR_HAL            0x00007F03    //send message dfs dumpt to Hal
#define EVT_SENSOR_HAL_TO_DFS            0x00007F04    //send message dfs dumpt to Hal
#define EVT_LPD_START                    0x00007F10    //event to start LPD
#define EVT_LPD_STOP                     0x00007F11    //event to stop LPD
