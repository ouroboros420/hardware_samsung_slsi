...
#ifndef __USI_6315_C__
#define __USI_6315_C__
...
static UsiInfoType mUsiInfo[USI_CHANNEL_MAX] = {
    ...
    DEC_USI(USI3_CHUB, SYSREG_BASE_ADDRESS + 0x2014),
    DEC_USI(USI4_CHUB, SYSREG_BASE_ADDRESS + 0x2040),
    DEC_USI(USI5_CHUB, SYSREG_BASE_ADDRESS + 0x2004),
    DEC_USI(USI6_CHUB, SYSREG_BASE_ADDRESS + 0x2030),
    DEC_USI(USI7_CHUB, SYSREG_BASE_ADDRESS + 0x2050),
};
