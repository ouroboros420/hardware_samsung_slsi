 ...
 *----------------------------------------------------------------------------
 *      Name:    cmgp.c
 *      Purpose: To implement CMGP APIs for 6315
 *      Rev.:    V1.00
 *----------------------------------------------------------------------------
 *
...
#ifndef __CMGP6315_C__
#define __CMGP6315_C__
...
#define SYSREG_CMGP_BASE_ADDRESS 0
#define SYSREG_CMGP2CHUB_BASE_ADDRESS 0
...
struct CmgpIrqInfoType mCmgpIrqInfo[0]= {
};
