 ...
 *----------------------------------------------------------------------------
 *      Name:    cmgp.c
 *      Purpose: To implement CMGP APIs for 9110
 *      Rev.:    V1.00
 *----------------------------------------------------------------------------
 *
...
#define SYSREG_CMGP_INTC_BASE                   (SYSREG_CMGP2CHUB_BASE_ADDRESS)
...
struct CmgpIrqInfoType mCmgpIrqInfo[]= {
  DEC_CMGP_IRQ(CMGP_USI0_IRQ, USI_CHUB0, CMGP_IRQ_GROUP_USI),
  DEC_CMGP_IRQ(CMGP_I2C0_IRQ, I2C_CHUB1, CMGP_IRQ_GROUP_I2C),
