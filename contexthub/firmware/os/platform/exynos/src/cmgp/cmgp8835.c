...
#ifndef __CMGP8835_C__
#define __CMGP8835_C__
...
struct CmgpIrqInfoType mCmgpIrqInfo[]= {
    ...
    DEC_CMGP_IRQ( CMGP_GPM14_0_IRQ, GPM14_0, CMGP_IRQ_GROUP_GPIO ),
    ...
    DEC_CMGP_IRQ( CMGP_GPM18_0_IRQ, GPM18_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM19_0_IRQ, GPM19_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM20_0_IRQ, GPM20_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM21_0_IRQ, GPM21_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM22_0_IRQ, GPM22_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM23_0_IRQ, GPM23_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM24_0_IRQ, GPM24_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM25_0_IRQ, GPM25_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM26_0_IRQ, GPM26_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM27_0_IRQ, GPM27_0, CMGP_IRQ_GROUP_GPIO ),
    DEC_CMGP_IRQ( CMGP_GPM28_0_IRQ, GPM28_0, CMGP_IRQ_GROUP_GPIO ),
    ...
    DEC_CMGP_IRQ( CMGP_USI4_IRQ, USI_CMGP4, CMGP_IRQ_GROUP_USI ),
    DEC_CMGP_IRQ( CMGP_I2C4_IRQ, I2C_CMGP9, CMGP_IRQ_GROUP_I2C ),
    DEC_CMGP_IRQ( CMGP_USI5_IRQ, USI_CMGP5, CMGP_IRQ_GROUP_USI ),
    DEC_CMGP_IRQ( CMGP_I2C5_IRQ, I2C_CMGP10,CMGP_IRQ_GROUP_I2C ),
    DEC_CMGP_IRQ( CMGP_USI6_IRQ, USI_CMGP6, CMGP_IRQ_GROUP_USI ),
    DEC_CMGP_IRQ( CMGP_I2C6_IRQ, I2C_CMGP11,CMGP_IRQ_GROUP_I2C ),
};
