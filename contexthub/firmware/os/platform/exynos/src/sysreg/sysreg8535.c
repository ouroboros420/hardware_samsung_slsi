...
#define    REG_SYSREG_I2C_CHUB01_SW_CONF           (SYSREG_BASE_ADDRESS + 0x2004)
#define    REG_SYSREG_USI_CHUB01_SW_CONF           (SYSREG_BASE_ADDRESS + 0x2008)
#define    REG_SYSREG_USI_CHUB02_SW_CONF           (SYSREG_BASE_ADDRESS + 0x200C)
#define    REG_SYSREG_I2C_CHUB02_SW_CONF           (SYSREG_BASE_ADDRESS + 0x2010)

#define    REG_SYSREG_USI_CHUB00_IPCLK             (SYSREG_BASE_ADDRESS + 0x2100)
#define    REG_SYSREG_I2C_CHUB01_IPCLK             (SYSREG_BASE_ADDRESS + 0x2104)
#define    REG_SYSREG_USI_CHUB01_IPCLK             (SYSREG_BASE_ADDRESS + 0x2108)
#define    REG_SYSREG_USI_CHUB02_IPCLK             (SYSREG_BASE_ADDRESS + 0x210C)
#define    REG_SYSREG_I2C_CHUB02_IPCLK             (SYSREG_BASE_ADDRESS + 0x2110)
...
void sysregSetOscEn(void) {
    __raw_writel(0x1, REG_SYSREG_OSCCLK_ENABLE);
}

void sysregSetOscDis(void) {
    __raw_writel(0x0, REG_SYSREG_OSCCLK_ENABLE);
}

void sysregSetCmgpReq(void) {
    __raw_writel(0x1, REG_SYSREG_CMGP_REQ_OUT);
}

void sysregClearCmgpReq(void) {
    __raw_writel(0x0, REG_SYSREG_CMGP_REQ_OUT);
}
