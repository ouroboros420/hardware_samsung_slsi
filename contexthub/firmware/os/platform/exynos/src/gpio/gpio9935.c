...
#define REG_GPIO_GPH5CON              (GPIO_BASE_ADDRESS + 0xA0)
#define REG_GPIO_GPB5CON              (GPIO_BASE_ADDRESS + 0xC0)
...
#define REG_GPIO_NWEINT_GPH5_CON      (GPIO_BASE_ADDRESS + 0x714)
#define REG_GPIO_NWEINT_GPB5_CON      (GPIO_BASE_ADDRESS + 0x718)
#define REG_GPIO_NWEINT_GPH0_FLTCON0  (GPIO_BASE_ADDRESS + 0x800)
#define REG_GPIO_NWEINT_GPH1_FLTCON0  (GPIO_BASE_ADDRESS + 0x804)
#define REG_GPIO_NWEINT_GPH2_FLTCON0  (GPIO_BASE_ADDRESS + 0x808)
#define REG_GPIO_NWEINT_GPH3_FLTCON0  (GPIO_BASE_ADDRESS + 0x80C)
#define REG_GPIO_NWEINT_GPH4_FLTCON0  (GPIO_BASE_ADDRESS + 0x810)
#define REG_GPIO_NWEINT_GPH5_FLTCON0  (GPIO_BASE_ADDRESS + 0x814)
#define REG_GPIO_NWEINT_GPH5_FLTCON1  (GPIO_BASE_ADDRESS + 0x818)
#define REG_GPIO_NWEINT_GPB5_FLTCON0  (GPIO_BASE_ADDRESS + 0x81C)
...
#define REG_GPIO_GPM15CON             (GPIO_CMGP_BASE_ADDRESS + 0x1C0)
#define REG_GPIO_GPM16CON             (GPIO_CMGP_BASE_ADDRESS + 0x1E0)
#define REG_GPIO_GPM17CON             (GPIO_CMGP_BASE_ADDRESS + 0x200)
#define REG_GPIO_GPQ0CON              (GPIO_CMGP_BASE_ADDRESS + 0x220)
...
#define REG_GPIO_NWEINT_GPM15_CON     (GPIO_CMGP_BASE_ADDRESS + 0x738)
#define REG_GPIO_NWEINT_GPM16_CON     (GPIO_CMGP_BASE_ADDRESS + 0x73C)
#define REG_GPIO_NWEINT_GPM17_CON     (GPIO_CMGP_BASE_ADDRESS + 0x740)
...
#define REG_GPIO_NWEINT_GPM15_FLTCON0 (GPIO_CMGP_BASE_ADDRESS + 0x838)
#define REG_GPIO_NWEINT_GPM16_FLTCON0 (GPIO_CMGP_BASE_ADDRESS + 0x83C)
#define REG_GPIO_NWEINT_GPM17_FLTCON0 (GPIO_CMGP_BASE_ADDRESS + 0x840)
...
struct Gpio mGpioPinInfo[] = {
    ...
    { DEC_CHUB_GPIO(GPH4, 2, 0) },
    { DEC_CHUB_GPIO(GPH4, 3, 0) },

    { DEC_CHUB_GPIO(GPH5, 0, 0) },
    { DEC_CHUB_GPIO(GPH5, 1, 0) },
    { DEC_CHUB_GPIO(GPH5, 2, 0) },
    { DEC_CHUB_GPIO(GPH5, 3, 0) },
    { DEC_CHUB_GPIO(GPH5, 4, 1) },
    { DEC_CHUB_GPIO(GPH5, 5, 1) },
    { DEC_CHUB_GPIO(GPH5, 6, 1) },

    { DEC_CHUB_GPIO(GPB5, 0, 0) },
    { DEC_CHUB_GPIO(GPB5, 1, 0) },
    { DEC_CHUB_GPIO(GPB5, 2, 0) },
    { DEC_CHUB_GPIO(GPB5, 3, 0) },

    { DEC_CMGP_GPIO(GPM00, 0, 0) },
    { DEC_CMGP_GPIO(GPM00, 1, 0) },
    { DEC_CMGP_GPIO(GPM01, 0, 0) },
    { DEC_CMGP_GPIO(GPM01, 1, 0) },
    { DEC_CMGP_GPIO(GPM02, 0, 0) },
    { DEC_CMGP_GPIO(GPM02, 1, 0) },
    { DEC_CMGP_GPIO(GPM03, 0, 0) },
    { DEC_CMGP_GPIO(GPM03, 1, 0) },
    { DEC_CMGP_GPIO(GPM04, 0, 0) },
    { DEC_CMGP_GPIO(GPM04, 1, 0) },
    { DEC_CMGP_GPIO(GPM05, 0, 0) },
    { DEC_CMGP_GPIO(GPM05, 1, 0) },
    { DEC_CMGP_GPIO(GPM06, 0, 0) },
    { DEC_CMGP_GPIO(GPM06, 1, 0) },
    { DEC_CMGP_GPIO(GPM07, 0, 0) },
    { DEC_CMGP_GPIO(GPM07, 1, 0) },
    { DEC_CMGP_GPIO(GPM08, 0, 0) },
    { DEC_CMGP_GPIO(GPM08, 1, 0) },
    { DEC_CMGP_GPIO(GPM09, 0, 0) },
    { DEC_CMGP_GPIO(GPM09, 1, 0) },
    { DEC_CMGP_GPIO(GPM10, 0, 0) },
    { DEC_CMGP_GPIO(GPM10, 1, 0) },
    { DEC_CMGP_GPIO(GPM11, 0, 0) },
    { DEC_CMGP_GPIO(GPM11, 1, 0) },
    { DEC_CMGP_GPIO(GPM12, 0, 0) },
    { DEC_CMGP_GPIO(GPM12, 1, 0) },
    { DEC_CMGP_GPIO(GPM13, 0, 0) },
    { DEC_CMGP_GPIO(GPM13, 1, 0) },
