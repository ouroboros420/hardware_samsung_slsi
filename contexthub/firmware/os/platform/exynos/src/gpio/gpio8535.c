...
//p-175
#define REG_GPIO_GPH00CON             (GPIO_BASE_ADDRESS + 0x00)

#define REG_GPIO_NWEINT_GPH00_CON     (GPIO_BASE_ADDRESS + 0x700)
#define REG_GPIO_NWEINT_GPH00_FLTCON0 (GPIO_BASE_ADDRESS + 0x800)
#define REG_GPIO_NWEINT_GPH00_FLTCON1 (GPIO_BASE_ADDRESS + 0x804)

//p-175
#define REG_GPIO_GPE00CON               (GPIO_CHUBEINT_BASE_ADDRESS + 0x00)
#define REG_GPIO_GPE01CON               (GPIO_CHUBEINT_BASE_ADDRESS + 0x20)
#define REG_GPIO_NWEINT_GPE00_CON       (GPIO_CHUBEINT_BASE_ADDRESS + 0x700)
#define REG_GPIO_NWEINT_GPE01_CON       (GPIO_CHUBEINT_BASE_ADDRESS + 0x704)
#define REG_GPIO_NWEINT_GPE00_FLTCON0   (GPIO_CHUBEINT_BASE_ADDRESS + 0x800)
#define REG_GPIO_NWEINT_GPE01_FLTCON0   (GPIO_CHUBEINT_BASE_ADDRESS + 0x804)
//p-176
...
struct Gpio mGpioPinInfo[] = {
    { DEC_CHUB_GPIO(GPH00, 0, 0) },
    { DEC_CHUB_GPIO(GPH00, 1, 0) },
    { DEC_CHUB_GPIO(GPH00, 2, 0) },
    { DEC_CHUB_GPIO(GPH00, 3, 0) },
    { DEC_CHUB_GPIO(GPH00, 4, 1) },
    { DEC_CHUB_GPIO(GPH00, 5, 1) },
    { DEC_CHUB_GPIO(GPH00, 6, 1) },
    { DEC_CHUB_GPIO(GPH00, 7, 1) },

    { DEC_CHUBEINT_GPIO(GPE00, 0, 0, 0) },
    { DEC_CHUBEINT_GPIO(GPE01, 0, 0, 1) },
