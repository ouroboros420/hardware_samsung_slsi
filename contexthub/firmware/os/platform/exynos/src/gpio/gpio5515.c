...
struct Gpio mGpioPinInfo[] = {
    { DEC_CHUB_GPIO(GPM00, 0, 0) },
    { DEC_CHUB_GPIO(GPM01, 0, 0) },
    { DEC_CHUB_GPIO(GPM02, 0, 0) },
    { DEC_CHUB_GPIO(GPM03, 0, 0) },
    { DEC_CHUB_GPIO(GPM04, 0, 0) },
    { DEC_CHUB_GPIO(GPM05, 0, 0) },
    { DEC_CHUB_GPIO(GPM06, 0, 0) },
    { DEC_CHUB_GPIO(GPM07, 0, 0) },
    { DEC_CHUB_GPIO(GPM08, 0, 0) },
    { DEC_CHUB_GPIO(GPM09, 0, 0) },
    { DEC_CHUB_GPIO(GPM10, 0, 0) },
    { DEC_CHUB_GPIO(GPM11, 0, 0) },
    { DEC_CHUB_GPIO(GPM12, 0, 0) },
    { DEC_CHUB_GPIO(GPM13, 0, 0) },
    { DEC_CHUB_GPIO(GPM14, 0, 0) },
    { DEC_CHUB_GPIO(GPM15, 0, 0) },
    { DEC_CHUB_GPIO(GPM16, 0, 0) },
    { DEC_CHUB_GPIO(GPM17, 0, 0) },
    { DEC_CHUB_GPIO(GPM18, 0, 0) },
    { DEC_CHUB_GPIO(GPM19, 0, 0) },
    { DEC_CHUB_GPIO(GPM20, 0, 0) },
    { DEC_CHUB_GPIO(GPM21, 0, 0) },
    { DEC_CHUB_GPIO(GPM22, 0, 0) },
    { DEC_CHUB_GPIO(GPM23, 0, 0) },
    { DEC_CHUB_GPIO(GPM24, 0, 0) },
    { DEC_CHUB_GPIO(GPM25, 0, 0) },
 };
