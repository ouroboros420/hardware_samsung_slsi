...
struct Gpio mGpioPinInfo[] = {
    ...
    { DEC_CHUB_GPIO(GPH01, 0, 0) },
    { DEC_CHUB_GPIO(GPH01, 1, 0) },
    { DEC_CHUB_GPIO(GPH01, 2, 0) },
    { DEC_CHUB_GPIO(GPH01, 3, 0) },
