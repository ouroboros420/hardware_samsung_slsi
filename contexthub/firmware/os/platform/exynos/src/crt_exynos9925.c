...
//FIXME
        ...
        ".word __defaultHandler                 \n" //ISR[7]  CSIS_VVALID5
        ".word __defaultHandler                 \n" //ISR[8]  CSIS_VVALID6
        ".word __defaultHandler                 \n" //ISR[9]  MAILBOX with GNSS
#if defined(MBAPM_REQUIRED)
        ".word mailboxAPM_IRQHandler            \n" //ISR[10] MAILBOX with APM
#else
        ".word __defaultHandler                 \n" //ISR[10] MAILBOX with APM
#endif
        ".word __defaultHandler                 \n" //ISR[11]  MAILBOX with CP
        ".word mailboxAP_IRQHandler             \n" //ISR[12]  MAILBOX with AP
        ".word cmgp_IRQHandler                  \n" //ISR[13]  SYSREG_CMGP secure
        ".word cmgp_IRQHandler                  \n" //ISR[14]  SYSREG_CMGP non-secure
        ".word rtc_IRQHandler                   \n" //ISR[15]  RTC_CHUB
        ".word __defaultHandler                 \n" //ISR[16]  MAILBOX with VTS
#if defined (EVT0)
        ".word __defaultHandler                 \n" //ISR[17]  DMAILBOX_CHUB
#elif defined (EVT1)
        ".word __defaultHandler                 \n" //ISR[17]  DNC
#endif
        ".word __defaultHandler                 \n" //ISR[18]  USI_CHUB0
        ...
        ".word __defaultHandler                 \n" //ISR[64]  UFD6
        ".word __defaultHandler                 \n" //ISR[65]  UFD7
        ".word __defaultHandler                 \n" //ISR[66]  MAILBOX with DNC
        ".word __defaultHandler                 \n" //ISR[67]  SPI_I2C_CHUB0
        ".word __defaultHandler                 \n" //ISR[68]  SPI_I2C_CHUB1
        ".word __defaultHandler                 \n" //ISR[69]  I3C_UFD
#elif defined (EVT1)
        ".word __defaultHandler                 \n" //ISR[56]  PDMA_UFD
        ".word __defaultHandler                 \n" //ISR[57]  UFD0
        ...
        ".word __defaultHandler                 \n" //ISR[59]  UFD2
        ".word __defaultHandler                 \n" //ISR[60]  reserved
        ".word __defaultHandler                 \n" //ISR[61]  MAILBOX with DNC
        ".word __defaultHandler                 \n" //ISR[62]  MAILBOX with ABOX
        ".word __defaultHandler                 \n" //ISR[63]  SPI_I2C_CHUB0
        ".word __defaultHandler                 \n" //ISR[64]  SPI_I2C_CHUB1
        ".word __defaultHandler                 \n" //ISR[65]  I3C_UFD
        ".word __defaultHandler                 \n" //ISR[66]  CSIS0
        ".word __defaultHandler                 \n" //ISR[67]  CSIS1
        ".word __defaultHandler                 \n" //ISR[68]  CSIS2
        ...
        ".word __defaultHandler                 \n" //ISR[71]  CSIS5
        ".word __defaultHandler                 \n" //ISR[72]  CSIS6
        ".word __defaultHandler                 \n" //ISR[73]  INTREQ_M_DMAILBOX_SEMA
        ".word __defaultHandler                 \n" //ISR[74]  INTREQ_M_PDMA_SEMA
        ".word __defaultHandler                 \n" //ISR[75]  INTREQ_DMAILBOX_SEMA
        ".word __defaultHandler                 \n" //ISR[76]  INTREQ_PDMA_SEMA
        ".word __defaultHandler                 \n" //ISR[77]  INT_RX_REQ0_DMAILBOX
        ".word __defaultHandler                 \n" //ISR[78]  INT_RX_REQ1_DMAILBOX
#endif
    );
};
