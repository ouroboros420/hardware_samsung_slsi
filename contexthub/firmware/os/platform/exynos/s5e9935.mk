...
SRCS_os += os/platform/$(PLATFORM)/src/platform.c \
	...
	os/platform/$(PLATFORM)/src/rtc/rtc_9935.c \
...
ifeq ($(MPU_SUPPORT), YES)
SRCS_os += os/platform/$(PLATFORM)/src/cpu/mpu.c
endif

ifeq ($(DMAILBOX_REQUIRED), YES)
FLAGS += -DDMAILBOX_REQUIRED
SRCS_os += os/platform/$(PLATFORM)/src/dmailbox/dmailbox.c
endif
...
ifeq ($(I3C_REQUIRED), YES)
SRCS_os += os/platform/$(PLATFORM)/src/i3c/i3c.c
endif
...
ifeq ($(MBCP_REQUIRED), YES)
FLAGS += -DMBCP_REQUIRED
SRCS_os += os/platform/$(PLATFORM)/src/mailbox/mailboxCp.c
endif
...
SRCS_os += os/platform/$(PLATFORM)/src/dvfs/dvfs.c
endif
