...
// ALS & PROX Sensor
#define ALSP_I2C_BUS_ID     I2C_CHUB6
#define PROX_INT_PIN        GPH5_3
#define PROX_GPIO_PIN       GPH5_3
#define PROX_IRQ            EXTINT_GPH5_3

// BAROMETER Sensor
#define BARO_I2C_BUS_ID     I2C_CHUB3
#define BARO_INT_PIN        GPH5_2
#define BARO_GPIO_PIN       GPH5_2

// MAG Sensor
#define MAG_I2C_BUS_ID      I2C_CHUB3
#define MAG_INT_PIN
#define MAG_GPIO_PIN
#define MAG_DRDY_PIN
...
#define BMI26X_INT1_IRQ         EXTINT_GPH5_1
#define BMI26X_INT1_PIN         GPH5_1
#undef USE_INT2
...
#define BMI26X_I3C_BUS_ID   I3C_CHUB0
#define ACC_GYR_INT1_PIN    EXTINT_GPH5_1
#define ACC_GYR_INT1_IRQ    GPH5_1
