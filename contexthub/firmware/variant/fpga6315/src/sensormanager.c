...
//	sensorType, sensorInterface, busId, addr, regAddr,  speed, priority
    {TYPE_SENSOR_ACC_GYRO/*SENS_TYPE_ACCEL*/,   0x0/*SPI*/, ACC_GYR_SPI_BUS_ID, ACC_I2C_ADDR/*none for SPI*/, ACC_REG_ID/*LSM6DSM_REG_ID*/, ACC_SPI_SPEED/*none for SPI*/, (PRI<<SHIFT_TYPE_ACCEL)},
