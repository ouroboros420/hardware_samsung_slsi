...
#ifndef _VARIANT_FPGA6315_H_
#define _VARIANT_FPGA6315_H_
...
#define SH_INT_WAKEUP               GPIO_PA(2)   /* HACK: ap: XEINT_31, sensorhub,wakeup-gpio */
#define SH_EXTI_WAKEUP_IRQ          EXTI2_IRQn  /* HACK: ap: XEINT_31, sensorhub,wakeup-gpio */
#define AP_INT_WAKEUP               GPH3_2 /* HACK: ap: XEINT_5, sensorhub,irq1-gpio */
#undef AP_INT_NONWAKEUP				 /* ap: XEINT_32, sensorhub,irq2-gpio */
...
// ALS
#define ALS_I2C_BUS_ID      I2C_CHUB0
#define ALS_INT_PIN
#define ALS_GPIO_PIN

// PROX Sensor
#define PROX_I2C_BUS_ID     I2C_CHUB0
#define PROX_INT_PIN        GPH3_2
#define PROX_GPIO_PIN       GPH3_2
//#define PROX_IRQ        EXTI15_10_IRQn

// BAROMETER Sensor
#define BARO_I2C_BUS_ID     I2C_CHUB5
#define BARO_INT_PIN        GPH3_3
#define BARO_GPIO_PIN       GPH3_3

// MAG Sensor
#define MAG_I2C_BUS_ID      I2C_CHUB1
#define MAG_INT_PIN
#define MAG_GPIO_PIN
#define MAG_DRDY_PIN
...
// ACCEL & GYRO Sensor
#define ACC_GYR_SPI_BUS_ID  SPI_CHUB1
#define ACC_GYR_INT_PIN1    GPH3_0
#define ACC_GYR_GPIO_PIN1   GPH3_0
#define ACC_GYR_INT_PIN2    GPH3_1
#define ACC_GYR_GPIO_PIN2   GPH3_1
