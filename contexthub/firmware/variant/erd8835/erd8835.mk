...
SRCS_os += $(VARIANT_PATH)/src/i3c.c
endif
...
ifeq ($(EVT), 0)
    FLAGS += -lexynos_fusion_evt0 -lm -L$(VARIANT_PATH)/src
else
    FLAGS += -lexynos_fusion_evt1 -lm -L$(VARIANT_PATH)/src
endif
endif
