...
FLAGS += -DCM55_BASE_ADDRESS=$(CM55_BASE_ADDRESS)
FLAGS += -DCM55_IPC_OFFSET=$(CM55_IPC_OFFSET)

ifeq ($(LPD_SUPPORT), YES)
FLAGS += -DLPD_SUPPORT
endif

ifeq ($(LPD_GPIO_RETENTION_CONTROL), YES)
FLAGS += -DLPD_GPIO_RETENTION_CONTROL
endif
...
ifeq ($(ALS_SENSOR), OPT3007)
SRCS_os += os/drivers/ti_opt3007/ti_opt3007.c
endif
