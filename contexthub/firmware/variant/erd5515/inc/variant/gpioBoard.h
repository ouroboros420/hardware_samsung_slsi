...
static const uint8_t mGpioPortInitValue[][7] = {
    ...
    {GPM02_0, GPM02_0_USI_CMGP00_RTS_SPIDI, GPIO_DAT_HIGH, GPIO_PUD_PULLUP, GPIO_CONPDN_OUTPUT_HIGH, GPIO_PUDPDN_DISABLE, GPIO_DRV_1X},
    ...
    // EINT - BARO_INT
    {GPM20_0, GPIO_CON_EINT, GPIO_DAT_HIGH, GPIO_PUD_DISABLE, GPIO_CONPDN_OUTPUT_LOW, GPIO_PUDPDN_DISABLE, GPIO_DRV_1X},
    // EINT - HRM_INT
