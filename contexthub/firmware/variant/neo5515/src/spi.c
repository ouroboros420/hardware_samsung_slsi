...
void spiBoardInit(void)
{
    ...
    for(i=0; i<num; i++){
        ...
        if      (portNum == SPI_CHUB0)  spiType=CMU_CLK_CHUB_USI0;
        else if (portNum == SPI_CMGP0)  spiType=CMU_CLK_CMGP_USI0;
        else if (portNum == SPI_CMGP1)  spiType=CMU_CLK_CMGP_USI1;
        else if (portNum == SPI_CMGP2)  spiType=CMU_CLK_CMGP_USI2;
        else if (portNum == SPI_CMGP3)  spiType=CMU_CLK_CMGP_USI3;
