...
//	sensorType, sensorInterface, busId, addr, regAddr,  speed, priority
    //{TYPE_SENSOR_ACC_GYRO/*SENS_TYPE_ACCEL*/,   0x1/*SPI*/, ACC_GYR_I2C_BUS_ID, ACC_I2C_ADDR/*none for SPI*/, ACC_REG_ID/*LSM6DSM_REG_ID*/, ACC_SPI_SPEED/*none for SPI*/, (PRI<<SHIFT_TYPE_ACCEL)},
    {TYPE_SENSOR_MAG/*SENS_TYPE_MAG*/,          0x2/*I2C*/, MAG_I2C_BUS_ID,     MAG_I2C_ADDR /*AK09918_I2C_ADDR*/, MAG_REG_ID/*AK09918_WIA1*/, MAG_I2C_SPEED/*A09918_I2C_SPEED*/, (PRI<<SHIFT_TYPE_MAG)},
};
