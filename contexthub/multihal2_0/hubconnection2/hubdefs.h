...
#define CONTEXTHUB_SETTINGS_PATH        "/mnt/vendor/efs/chub/sensorcal.json"
...
enum {
    ...
    SENSOR_TYPE_ANY_MOTION		= SENSOR_TYPE_DEVICE_PRIVATE_BASE + 9,
    SENSOR_TYPE_PEDOMETER		= SENSOR_TYPE_DEVICE_PRIVATE_BASE + 10,
};
