///
/// @file exynos_ion_memory_manager.h
...
class ExynosIonMemoryManager : public MemoryManager {
public:
        ExynosIonMemoryManager();
        ~ExynosIonMemoryManager();
        ExynosIonMemoryManager(const MemoryManager&) = delete;
        ExynosIonMemoryManager(const MemoryManager&&) = delete;
        ExynosIonMemoryManager& operator=(const MemoryManager&) = delete;
        ExynosIonMemoryManager& operator=(const MemoryManager&&) = delete;
